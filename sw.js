...
const ASSETS = [
  ...
  "./articles/eiopa-ai-chatbot-insurance-distribution-broker-responsibility-2026.html",
  "./articles/marsh-broker-workbench-ai-placement-approval-2026.html",
  "./articles/lititz-guidewire-ai-agent-knowledge-version-control-2026.html",
  "./articles/ukraine-war-risk-business-seminar-24-september-2026.html",
  "./articles/mosaic-halo-ai-broker-submissions-and-quote-controls-2026.html",
  "./articles/construction-claims-ai-preparation-marsh-australia-2026.html",
  "./articles/ukraine-first-loss-war-damage-proposal-september-2026.html",
  "./articles/earnix-agent-hub-insurance-ai-authority-controls-2026.html",
  "./articles/ukraine-war-risk-programme-expansion-september-2026.html",
  "./articles/ai-broker-pilot-measuring-value-brokertech-2026.html",
  "./articles/ai-broker-policy-comparison-and-document-workflow-2026.html",
  "./articles/ai-client-questions-broker-policy-review-2026.html",
  "./articles/ai-insurance-advice-human-agent-survey-2026.html",
  "./articles/ai-client-risk-discovery-broker-renewal-2026.html",
  "./articles/sapiens-ai-document-mapping-insurance-workflows-2026.html",
  "./articles/eca-august-2026-export-insurance-and-risk-boundaries.html",
...
"./my-documents.js?v=1",
  ...
  "./contract-quality-report.mjs?v=8",
  "./contacts.html",
  "./contacts.css?v=1",
  "./contacts.js?v=2",
...
self.addEventListener("fetch", (event) => {
  ...
  if (event.request.mode === "navigate") {
    const isContractCheck = url.pathname === "/check" || url.pathname === "/check/" || url.pathname === "/check/index.html";
    const fallback = isContractCheck ? "./check/index.html"
      : url.pathname === "/contract-quality.html" ? "./contract-quality.html"
      : url.pathname.endsWith("/geocode.html") ? "./geocode.html" : "./index.html";
